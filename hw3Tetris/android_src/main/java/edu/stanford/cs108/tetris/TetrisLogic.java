...
//    public static final int HEIGHT = 8;
    ...
    // When this is true, use TetrisBrainLogic
    ...
    public void setBrainMode(boolean isBrainMode) {
        brainMode = isBrainMode;
    }
    ...
    /**
     ...
     If the placement is not possible, then the placement is undone, and the board is not changed.
    ...
    /**
     ...
     The board should be in the committed state -- i.e. the piece should not be in the board at the moment.
     This is necessary so dropHeight() may be called without the piece "hitting itself" on the way down.

     Sets the ivars newX, newY, and newPiece to hold what it thinks the new piece position should be.
     (Storing an intermediate result like that in ivars is a little tacky.)
     */

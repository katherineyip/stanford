...
public interface Brain {
    // Move is used as a struct to store a single Move ("static" here means it does not have a
    // pointer to an enclosing Brain object, it's just in the Brain namespace.)
